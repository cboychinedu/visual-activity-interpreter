...
const Navbar = () => {
    ...
    // Else if the cookie is not present, execute the block 
    // of code below 
    else {
        // set the isLoggedIn value as false 
        isLoggedIn = false; 
    }
        ...
        return (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="hidden md:block">
                    ...
                    <a href="/dashboard" className="text-gray-300 hover:text-blue-400 px-3 py-2 transition-colors">Dashboard</a>
                    <a href="/history" className="text-gray-300 hover:text-blue-400 px-3 py-2 transition-colors"> History </a>
                    <a onClick={handleLogout} className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-medium transition-all shadow-lg shadow-blue-500/20">
                        Logout
                    </a>
                    </div>
                </div>
            ...
            {isOpen && (
                ...
                <a href="/dashboard" className="text-gray-300 block px-3 py-2">Dashboard</a>
                <a href="/history" className="text-gray-300 block px-3 py-2"> History </a>
                <a onClick={handleLogout} className="text-blue-400 block px-3 py-2 font-bold">Logout</a>
                </div>
            )}
            </nav>
        );
    ...
    // Else if the user's is not logged in 
    else {
        // Execute the block of code below if the user is not logged in 
        // Rendering the Navbar component 
        return (
            <nav className="bg-slate-900 border-b border-slate-800 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
